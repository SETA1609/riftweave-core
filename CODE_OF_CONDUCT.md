...
The maintainers and contributors of Riftweave have elected to govern their
interactions with each other, with users, and with the larger community in
...
(hereafter, "The Rule"). This code of conduct has proven its mettle in thousands of
diverse communities for over 1,500 years, and has served as a baseline for many
civil law codes since the time of Charlemagne.

This code of conduct is adopted from the [SQLite project](https://sqlite.org/codeofethics.html).

## Scope

This code of conduct applies to all interactions with the Riftweave project,
whether or not expressly stated, including the issue tracker, pull requests, commit
messages, and any other communication channels associated with the project.

The founders and contributors who have adopted this code of conduct have done so,
not because they necessarily believe its precepts are or ought to be enforceable as
law, but rather because they aspire to those high ideals, and they want to set an
example of civility and decency that they hope others will follow. The principles of
The Rule are aspirational. No one is expected to achieve perfect adherence, but
rather to honestly strive toward the ideal, and to grant others the same grace when
they fall short.
...
43. But always recognize the evil that is your own doing, and impute it to yourself.
...
These, then, are the tools of the spiritual craft. If we employ them unceasingly day
and night, and return them on the Day of Judgment, our compensation from the Lord
will be that reward He has promised: "Things that no eye has seen, nor ear heard, nor
mind imagined, the things that God has prepared for those who love him."
